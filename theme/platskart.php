...
?>
    <div class="title-wrapper">
      <div class="container"><div class="container-inner">
        ...
        <h1><span>Плацкартные</span>вагоны</h1>
      ...
      <div class="container">
        <ul class="breadcrumb">
            <li><a href="shop-index.php">Главная</a></li>
              <li class="active">Плацкартные вагоны</li>
        </ul>
 ...
 <!-- BEGIN SIDEBAR -->
               ...
               <a href="javascript:void(0);" class="collapsed">
                ...
                <li><a href="kupe.php"><i class="fa fa-angle-right"></i> Купейный</a></li>
                  <li class="list-group-item dropdown clearfix active">
                   <a href="javascript:void(0);" class="collapsed"><i class="fa fa-angle-right"></i>Плацкартный</a>
                                 </li>                              
		...
		<?php
				...
				$result1=mysql($dbName,"select idinstock from instock where instock.idtype='10' and amount>0");	
