...
?>
    <div class="title-wrapper">
      <div class="container"><div class="container-inner">
        ...
        <h1><span>Фитинговые</span>платформы</h1>
      ...
      <div class="container">
        <ul class="breadcrumb">
            <li><a href="shop-index.php">Главная</a></li>
              <li class="active">Фитинговые платформы</li>
        </ul>
            ...
            <ul class="list-group margin-bottom-25 sidebar-menu">
                ...
                <ul class="dropdown-menu" style="display:block;">
                  ...
                  <li class="list-group-item dropdown clearfix active">
                   <a href="javascript:void(0);" class="collapsed"><i class="fa fa-angle-right"></i>Фитинговая платформа</a>
                                 </li>
		...
		<?php
				...
				$result1=mysql($dbName,"select idinstock from instock  where instock.idtype='5' and amount>0");	
