              ...
              <ul class="scroller" style="height: 250px;">
                  ...
                  <?php
					...
					?> 
                       <li>     
                    <?php
                  	$result=mysql($dbName,"select picture from instock join shop_cart on shop_cart.goods_id=instock.idinstock where instock.idinstock='".$i[0]."' and uid='$uniq'"); 
                  ...
                  <strong ><?php
                  	...
                  	$result3=mysql($dbName,"select title from instock  join shop_cart on shop_cart.goods_id=instock.idinstock where instock.idinstock='".$i[0]."' and uid='$uniq'");
