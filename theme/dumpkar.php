    ...
    <div class="main">
      <div class="container">
            ...
            <ul class="list-group margin-bottom-25 sidebar-menu">
                ...
                <ul class="dropdown-menu" style="display:block;">
                  ...
                  <li class="list-group-item dropdown clearfix active">
                   <a href="javascript:void(0);" class="collapsed"><i class="fa fa-angle-right"></i> Думпкар </a>
                                 </li>
		...
		<?php
				...
				$result1=mysql($dbName,"select idinstock from instock  where instock.idtype='8' and amount>0");	
