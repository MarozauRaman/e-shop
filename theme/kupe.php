...
?>
    <div class="title-wrapper">
      <div class="container"><div class="container-inner">
        ...
        <h1><span>Купейные</span>вагоны</h1>
      ...
      <div class="container">
        <ul class="breadcrumb">
            <li><a href="shop-index.php">Главная</a></li>
              <li class="active">Купейные вагоны</li>
        </ul>
               ...
               <a href="javascript:void(0);" class="collapsed">
                ...
                <ul class="dropdown-menu" style="display:block;" >
                  ...
                  <li class="list-group-item dropdown clearfix active">
                   <a href="javascript:void(0);" class="collapsed"><i class="fa fa-angle-right"></i> Купейный </a>
                                 </li>                              
		...
		<?php
				...
				$result1=mysql($dbName,"select idinstock from instock where instock.idtype='9' and amount>0");	
