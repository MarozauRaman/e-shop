...
?>
    <div class="title-wrapper">
      <div class="container"><div class="container-inner">
        ...
        <h1><span>Вагоны-рестораны</span></h1>
      ...
      <div class="container">
        <ul class="breadcrumb">
            <li><a href="shop-index.php">Главная</a></li>
              <li class="active">вагоны-рестораны</li>
        </ul>
...
<!-- BEGIN SIDEBAR -->
                ...
                <li><a href="kupe.php"><i class="fa fa-angle-right"></i> Купейный</a></li>
                 <li><a href="platskart.php"><i class="fa fa-angle-right"></i>Плацкартный</a></li>
                  ...
                  <li class="list-group-item dropdown clearfix active">
                   <a href="javascript:void(0);" class="collapsed"><i class="fa fa-angle-right"></i>Вагон-ресторан</a>
                                 </li>                              
		...
		<?php
				...
				$result1=mysql($dbName,"select idinstock from instock  where instock.idtype='12' and amount>0");	
