...
?>
    <div class="title-wrapper">
      <div class="container"><div class="container-inner">
        ...
        <h1><span>Платформы</span>для перевозки леса</h1>
      ...
      <div class="container">
        <ul class="breadcrumb">
            <li><a href="shop-index.php">Главная</a></li>
              <li class="active">Платформы для перевозки леса</li>
        </ul>
            ...
            <ul class="list-group margin-bottom-25 sidebar-menu">
                ...
                <ul class="dropdown-menu" style="display:block;">
                  ...
                  <li class="list-group-item dropdown clearfix active">
                   <a href="javascript:void(0);" class="collapsed"><i class="fa fa-angle-right"></i>Платформы для перевозки леса </a>
                                 </li>
		...
		<?php
				...
				$result1=mysql($dbName,"select idinstock from instock where instock.idtype='6' and amount>0");	
